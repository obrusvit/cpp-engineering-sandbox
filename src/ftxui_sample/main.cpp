...
// configuration step. It creates a namespace called `cpp_engineering_sandbox`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cpp_engineering_sandbox::cmake::project_name, cpp_engineering_sandbox::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cpp_engineering_sandbox::cmake::project_version);
      return EXIT_SUCCESS;
    }
